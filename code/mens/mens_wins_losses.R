...
data <- data.frame()
schedule <- data.frame()
conf <- read_csv("../../data/mens/mens_team_conferences.csv")
...
home <- schedule %>%
  select(id, team = home.location, neutralSite, conferenceCompetition) %>%
  mutate(home = T)

away <- schedule %>%
  select(id, team = away.location, neutralSite, conferenceCompetition) %>%
  mutate(home = F)
...
data <- data %>%
  mutate(win = ifelse(points > points_opp, 1, 0),
         ...
         home = home & !neutralSite,
         on_road = !home & !neutralSite,
         ...
         major_neutral_win = ifelse(win == 1 & major_opp == 1 & neutralSite, 1, 0),
         ...
         major_neutral_loss = ifelse(loss == 1 & major_opp == 1 & neutralSite, 1, 0),
         ...
         mid_major_neutral_win = ifelse(win == 1 & mid_major_opp == 1 & neutralSite, 1, 0),
         ...
         mid_major_neutral_loss = ifelse(loss == 1 & mid_major_opp == 1 & neutralSite, 1, 0),
         ...
         neutral_win = ifelse(win == 1 & neutralSite, 1, 0),
         neutral_loss = ifelse(loss == 1 & neutralSite, 1, 0),
         conf_win = ifelse(win == 1 & conferenceCompetition, 1, 0),
         conf_loss = ifelse(loss == 1 & conferenceCompetition, 1, 0),
         nonconf_win = ifelse(win == 1 & !conferenceCompetition, 1, 0),
         nonconf_loss = ifelse(loss == 1 & !conferenceCompetition, 1, 0),
         conf_home_win = ifelse(win == 1 & conferenceCompetition & home, 1, 0),
         conf_home_loss = ifelse(loss == 1 & conferenceCompetition & home, 1, 0),
         conf_away_win = ifelse(win == 1 & conferenceCompetition & on_road, 1, 0),
         conf_away_loss = ifelse(loss == 1 & conferenceCompetition & on_road, 1, 0),
         nonconf_home_win = ifelse(win == 1 & !conferenceCompetition & home, 1, 0),
         nonconf_home_loss = ifelse(loss == 1 & !conferenceCompetition & home, 1, 0),
         nonconf_away_win = ifelse(win == 1 & !conferenceCompetition & on_road, 1, 0),
         nonconf_away_loss = ifelse(loss == 1 & !conferenceCompetition & on_road, 1, 0))
...
write_csv(record, "../../data/mens/mens_records.csv")
