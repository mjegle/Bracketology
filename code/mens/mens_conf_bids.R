...
reb <- read_csv("../../data/mens/reb_rates.csv") # Only need this for the year column
teams_conf <- read_csv("../../data/mens/team_conferences.csv")
...
write_csv(conf_bids, "../../data/mens/mens_conf_bids.csv")
